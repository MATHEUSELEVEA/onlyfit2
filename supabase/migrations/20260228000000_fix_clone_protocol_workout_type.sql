-- Fix: clone_protocol_for_student usava workout_type='coach_plan' que viola
-- o CHECK workouts (apenas 'drop','coach_individual','challenge','template').
-- Treinos clonados para aluno são prescrições individuais -> coach_individual.
-- Existem 2 overloads: 3 params e 5 params (p_starts_at, p_ends_at) - frontend chama a 5.
-- =============================================================================
-- Overload 1: 3 params (legado)
-- =============================================================================
...
-- =============================================================================
-- Overload 2: 5 params (p_starts_at, p_ends_at) - usado pelo frontend
-- =============================================================================
CREATE OR REPLACE FUNCTION clone_protocol_for_student(
  p_protocol_id UUID,
  p_student_id UUID,
