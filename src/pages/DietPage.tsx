...
export function DietPage() {
  ...
  const confirmMeal = (id: string) => { setMeals((current) => current.map((meal) => meal.id === id ? { ...meal, status: meal.status === 'done' ? 'next' : 'done' } : meal)); setSelected(null); };
